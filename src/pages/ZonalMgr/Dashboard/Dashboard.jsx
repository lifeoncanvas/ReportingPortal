...
const KPI = [
  { label: 'Total Reports',    value: '5',      sub: '5 this week',       pct: '+12%', iconBg: '#ede9fe', iconColor: '#5b21b6',
  ...
  { label: 'Total Finance',    value: '$24.9K', sub: '5 entries',         pct: '+8%',  iconBg: '#dcfce7', iconColor: '#16a34a',
  ...
  { label: 'Total Attendance', value: '2460',   sub: 'Across all regions', pct: '+24%', iconBg: '#e0f2fe', iconColor: '#0284c7',
  ...
  { label: 'Completion Rate',  value: '92%',    sub: 'This week',          pct: '+18%', iconBg: '#fff7ed', iconColor: '#ea580c',
    ...
    <div className="zd-page">
      ...
      <div className="zd-reminder">
        <div className="zd-reminder-left">
          <p className="zd-reminder-title">Weekly Report Reminder</p>
          <p className="zd-reminder-desc">
            Don't forget to submit your weekly report by end of day Thursday.
          </p>
          <button
            className="zd-reminder-btn"
            onClick={() => navigate('/zonal/reporting')}
          >
